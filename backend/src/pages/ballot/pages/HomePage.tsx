  ...
  const meetingQuickLinks = [
    {
      ...
      desc: "จัดการแบบร่างการเวียนขอข้อคิดเห็น",
    ...
    },
    {
      ...
      desc: "จัดการเวียนขอข้อคิดเห็นทยังไม่อนุมัติ",
      ...
      >
        ...
        <Box sx={{ display: "flex", alignItems: "center", gap: 1, mt: 2 }}>
          ...
          <Typography variant="body2" sx={{ opacity: 0.9 }}>
            ระบบจัดการข้อคิดเห็นแบบครบวงจร
          </Typography>
        </Box>
      </Paper>
